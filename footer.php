  		...
  		<div class="container">
  			<div class="footers20-content">
  				<div class="d-grid grid-col-4 grids-content">
  					<div class="column">
  						<h4>Address</h4>
  						<p class="contact-para3">Your Address,City,State</p>
  						
  					</div>
  					<div class="column">
  						<h4>contact Us</h4>
  						<a href="tel:02642 246 402">
  							<p class="contact-phone mt-2">+91 1234336588</p>
  						</a>
  					</div>
  					<div class="column">
  						<h4>Opening hours</h4>
  						<p>Monday - Friday</p>
                          <p class="mt-2">09:00 am to 09:00 pm</p>
                          <p class="mt-2">Saturday</p>
  						<p class="mt-2">09:00 am to 05:00 pm</p>
  					</div>
  				</div>
  				<div class="d-grid grid-col-3 grids-content1 bottom-border">
  					<div class="columns copyright-grid">
  						<p class="copy-footer-29">© 2024 Canteen Management Project. All rights reserved 					
  					</div>

  ...
  <header id="site-header" class="fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand" href="#index.html">
          <img src="images/site_logo-old.png" alt="Your logo" title="Your logo"  />
      </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="px-4 fill-none">
              <a href="menu.php" class="btn btn-style btn-secondary"><span class="fa fa-shopping-cart mr-2"></span>Order now</a>

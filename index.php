    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modal__content"> 
          <h2 class="logo">
            <img src="assets/images/site_logo_old.png" alt="Your logo" title="Your logo" style="height:35px;" />
          </h2>
          ...
          <div class="widget-social-icons mt-sm-5 mt-4">
            ...
            <ul class="icon-rounded address">
              ...
              <li class="mt-3">
                <p><span class="fa fa-phone"></span> <a href="tel:+404-11-22-89">+91 7659388390</a></p>
              </li>
              <li class="mt-2">
        ...
        <div class="container">
            <div class="row middle-section">
                <div class="col-lg-7 section-width align-self">
                    <h5>Enjoy Canteen's Delicious Food</h5>
                    <h2>Eat Healthy food everyday</h2>
                    <a href="menu.php" class="btn btn-secondary btn-outline-style mt-md-5 mt-4">Explore Menu</a>
                </div>
                <div class="col-lg-5 history-info mt-lg-0 mt-5 pt-md-4">
                    <img src="images/img1.png" class="img-fluid" alt="image">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="foods1 py-5">
        <div class="container py-lg-5 py-md-4">
            <div class="title-content text-center">
                <h6 class="sub-title">Our Menu</h6>
                <h3 class="title-big">Enjoy Our Delicious Food</h3>
            </div>
                            ...
                            <div class="item">
                                <div class="d-grid food-info">
                                    ...
                                    <h4 class="name-pos"><a href="#url"><?php echo $product['title']; ?></a></h4>
                                        ...
                                        <a href="dishes.php?c_id=<?php echo $product['c_id']; ?>&action=add1&id=<?php echo $product['d_id']; ?>" class="btn-style btn-primary btn mt-4" >Add to cart</a>
                                    </div>
                                </div>
                            </div>  
                <?php
    ...
    <div class="container py-lg-5 py-md-4">
        <div class="row">
            <div class="col-lg-6">
                ...
                <h5 class="mt-lg-3 mt-2">Best food in budget and you can get it fresh and hot.
                </h5>
                <p class="mt-sm-4 mt-3 mb-sm-0 mb-2"></p>
                <a href="contact.php" class="btn-style btn-primary btn mt-lg-5 mt-4">get in touch with us</a>
            </div>
